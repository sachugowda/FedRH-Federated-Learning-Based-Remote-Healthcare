...
df1 = df1[(df1['subject'] != 'subject1') & (df1['subject'] != 'subject2') & (df1['subject'] != 'subject5') & (df1['subject'] != 'subject6')  & (df1['subject'] != 'subject7') & (df1['subject'] != 'subject8')]
#y = df1.Activity
...
class FlowerClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        r = model.fit(X_train, y_train, epochs=5, validation_data=(X_test, y_test), verbose=0 , callbacks=[tensorboard_callback])
        hist = r.history
...
fl.client.start_numpy_client(
        #server_address="3.86.195.52:8080", 
